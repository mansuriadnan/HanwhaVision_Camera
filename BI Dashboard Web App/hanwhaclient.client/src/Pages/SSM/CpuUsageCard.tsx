...
const CpuUsageCard: React.FC<Props> = ({ used, breakdown, lineChart, startDate, endDate  }) => {
       ...
       <Box  className="ssm-pop-card-wrapper">
        ...
        <Box className="ssm-pop-card-left">
          <Box className="ssm-pop-card-inner-head">
            <Typography>{t("SSM_Dashboard.CPU")}</Typography>
          ...
          {breakdown.map((item, i) => {          
            ...
            return (
              <Box className='ssm-pop-card-details' key={i} sx={{ display: "flex", alignItems: "center", mt: 1 }}>
                <Typography>
