...
import { UploadBulkVehicle } from "../../services/anprService";

type BulkUploadVehicleProps = {
  onClose: () => void;
  refreshData: () => void;
};

const BulkUploadVehicle: React.FC<BulkUploadVehicleProps> = ({
    onClose,
    refreshData,
}) => {
   const [vehicleFile, setVehicleFile] = useState<File | null>(null);
     ...
     const handleSaveFiles = async () => {
       if (!vehicleFile) {
         showToast("Please upload vehicle files.", "error");
         return;
       }
   
       // Validate file extensions
       const vehicleFileName = vehicleFile.name.toLowerCase();
   
       const validExtensions = [".xls", ".xlsx"];
   
       const isValid = validExtensions.some((ext) => vehicleFileName.endsWith(ext));
       ...
       try {
         const data = await UploadBulkVehicle(formData);
         if (
           typeof data === "object" &&
           data !== null &&
           "isSuccess" in data &&
         ...
         <Grid className="add-license-pop-wrapper">
           <Grid item xs={10} md={10} lg={10}>
             <Typography variant="h6" fontWeight={600}>
              {t("ANPR_Screen.Owner.Upload_your_vehicle_file")}
             </Typography>
             ...
             <Box className="upload-your-file">
                   ...
                   <div className="upload-your-file-name">
                     ...
                     <Typography variant="subtitle1" gutterBottom>
                       {t(
                         ...
                         {
                           fileName: vehicleFile.name,
                         }
                       )}
                     </Typography>
                   </div>
                   <IconButton onClick={handleVehicleFileEdit}>
               ...
               <input
                 ...
                 hidden
                 onChange={handleBulkVehicleUpload}
