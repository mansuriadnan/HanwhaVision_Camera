...
const VehicleWidget: React.FC<CommonWidgetProps> = ({
  item,
  floor,
  zones,
  selectedStartDate,
                ...
                {(() => {
                  ...
                  return (
                    <div style={{
                      ...
                      <table
                        ...
                        {grouped.length > 0 ? (
                         <>
                          ...
                          {/* Average Row */}
                          <tr style={{ fontWeight: 600,pageBreakInside: "avoid",
                              breakInside: "avoid" }}>
                      ...
                      {grouped.length > 0 && (() => {
                      const highest = grouped.reduce((max, r) => (r.inCount > max.inCount ? r : max), grouped[0]);
                        const lowest = grouped.reduce((min, r) => (r.inCount < min.inCount ? r : min), grouped[0]);
                          ...
                          <div style={{ marginTop: 10 }}>
                            ...
                            >
                              <li style={{ lineHeight: "18px"}}>
                                Day {highestLabel} has the highest vehicle in count (
                                {formatNumber(highest.inCount)})
                              </li>
                              <li style={{ lineHeight: "18px"}}>
                                Day {lowestLabel} has the lowest vehicle in count (
                                {formatNumber(lowest.inCount)})
                              </li>
                            </ul>
                          </div>
                        );
