...
const VehicleInWrongDirection2_1_Option2: React.FC<
  IVehicleInWrongDirectionProps
> = ({
  customizedHeight,
  customizedWidth,
  ...
  setExportHandler,
    ...
    useEffect(() => {
      ...
      gradient
        .append("stop")
        .attr("offset", "0%")
        .attr("stop-color", "#AFE8FF1A");

      gradient
        .append("stop")
        .attr("offset", "100%")
        .attr("stop-color", "#AFE8FF");
        ...
        .on("mousemove", function (event) {
          ...
          if (closest) {
            d3.select("#tooltip")
              .style("opacity", 1)
              .html(
                `<strong>Wrong Direction</strong> : ${formatNumber(
                  closest.value
                )}`
              )
...
export { VehicleInWrongDirection2_1_Option2 };
