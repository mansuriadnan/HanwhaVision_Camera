...
const PeopleQueueEvent2_1_Option3: React.FC<IPeopleQueueEventsProps> = ({
  ...
  useEffect(() => {
    ...
    const gradient = defs
      ...
      .attr("id", "maxBarGradientPQE")
      .attr("x1", "0%")
      .attr("y1", "0%")
      .attr("x2", "0%")
      .attr("y2", "100%");

    gradient.append("stop").attr("offset", "0%").attr("stop-color", "#FFEB10");

    gradient
      .append("stop")
      .attr("offset", "100%")
      .attr("stop-color", "#FFEB10");
    ...
    chartGroup
      .append("path")
      .datum(finalData)
      .attr("fill", "url(#maxBarGradientPQE)")
      .attr("d", area);
    ...
    chartGroup
      ...
      .attr("href", "/images/dashboard/People_Queue_Events_Option3_Node.svg")
      .attr("href", "/images/dashboard/People_Queue_Events_Option3_Node.svg")
      ...
      .on("mouseover", (_, d) => {
        d3.select("#tooltip")
          .style("opacity", 1)
          .html(`<strong>People Queue</strong> : ${formatNumber(d.value)}`);
      })
      .on("mousemove", (event) => {
        d3.select("#tooltip")
...
export { PeopleQueueEvent2_1_Option3 };
