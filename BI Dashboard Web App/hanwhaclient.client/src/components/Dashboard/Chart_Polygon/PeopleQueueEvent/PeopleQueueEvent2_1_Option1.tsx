...
import peopleQueueIcon from "/images/dashboard/People_Queue_Events_Option1_Node.svg";
import { getTimeTickFormatter } from "../../../../utils/formatTimeTick";
import { useTimeFormatContext } from "../../../../context/TimeFormatContext";

const PeopleQueueEvent2_1_Option1: React.FC<IPeopleQueueEventsProps> = ({
  ...
  useEffect(() => {
    ...
    // More yellow closer to the line (top)
    gradient
      .append("stop")
      .attr("offset", "0%")
...
export { PeopleQueueEvent2_1_Option1 };
