...
import speedlightimg from "/images/dashboard/red_node_icon.svg";
import speeddarkimg from "/images/dark-theme/dashboard/green_node_icon.svg";
import { useTimeFormatContext } from "../../../../context/TimeFormatContext";
import { getTimeTickFormatter } from "../../../../utils/formatTimeTick";


const SpeedViolationbyVehicle2_1_Option1: React.FC<
  ISpeedViolationByVehicleProps
> = ({
  customizedWidth,
  customizedHeight,
  ...
  useEffect(() => {
    ...
    chartGroup
      ...
      .datum(finalData)
      .attr("fill", "none")
      .attr("stroke", theme === 'light' ? "#F90000" : "#D5E387")
      .attr("stroke-width", 2)
      .attr("d", line);
    ...
    chartGroup
      ...
      .attr("href",  theme === 'light' ? speedlightimg : speeddarkimg)
...
export { SpeedViolationbyVehicle2_1_Option1 };
