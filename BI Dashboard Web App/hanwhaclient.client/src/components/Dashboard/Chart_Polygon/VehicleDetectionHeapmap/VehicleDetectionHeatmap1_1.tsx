...
const VehicleDetectionHeatmap1_1: React.FC<IHeatmapProps> = ({
  heatmapData,
  customizedHeight,
  customizedWidth,
  displayName,
  ...
  const CANVAS_WIDTH = 170 //heatmapData?.resolutionWidth ?? 170;
  const CANVAS_HEIGHT = 96 //heatmapData?.resolutionHeight ?? 96;
    ...
    <Box sx={{ width: customizedWidth }}>
      <Box className="widget-main-wrapper">
          ...
          <div className="widget-data-wrapper">
            <div className="People-counting-heatmap">
              ...
              {data.length == 0 ?
                ...
                :
                <div className="cmn-heatmap-wrapper">
                  <img
        ...
        <Box className="widget-main-footer">
          ...
          {!openZoomDialog ? (
            <Box className="widget-main-footer-zoom-i" onClick={onZoomClick} id="zoomwidgetBtnVehicleDetectionHeatmap">
              <img
...
export { VehicleDetectionHeatmap1_1 };
