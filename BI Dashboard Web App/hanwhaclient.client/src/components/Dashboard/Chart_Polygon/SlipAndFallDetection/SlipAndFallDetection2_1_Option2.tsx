...
const SlipAndFallDetection2_1_Option2: React.FC<ISlipAndFallProps> = ({
  customizedHeight,
  customizedWidth,
  slipAndFallData,
  startDate,
      ...
      .on("mousemove", function (event) {
        ...
        if (closest) {
          d3.select("#tooltip")
            ...
            .html(
              `<strong>Slip & Fall : </strong> ${formatNumber(closest.value)}`
            );
        } else {
...
export { SlipAndFallDetection2_1_Option2 };
