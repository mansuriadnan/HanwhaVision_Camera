...
const ZoneWiseCapacityUtilizationForVehicle2_1_Option2: React.FC<
  IZoneWiseCapacityUtilizationAnalysisProps
> = ({
  customizedWidth,
  customizedHeight,
  ...
  setExportHandler,
    ...
    useEffect(() => {
      ...
      categories.forEach((cat) => {
        ...
        const safeKey = cat.key.replace(/\s+/g, "-");
        // Circles
        MultiLinechartGroup.selectAll(`.circle-${safeKey}`)
...
export { ZoneWiseCapacityUtilizationForVehicle2_1_Option2 };
