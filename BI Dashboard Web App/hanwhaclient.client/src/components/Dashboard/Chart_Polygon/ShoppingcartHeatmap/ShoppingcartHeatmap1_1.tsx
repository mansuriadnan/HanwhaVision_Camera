...
const ShoppingcartHeatmap1_1: React.FC<IHeatmapProps> = ({
  heatmapData,
  // customizedHeight,
  customizedWidth,
  displayName,
    ...
    <Box sx={{ width: customizedWidth }}>
      <Box className="widget-main-wrapper">
        ...
        <Box className="widget-main-footer">
          ...
          {!openZoomDialog ? (
            <Box className="widget-main-footer-zoom-i" onClick={onZoomClick} id="zoomwidgetBtnShoppingCartHeatmap">
              <img
