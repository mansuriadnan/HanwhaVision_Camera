...
import { LocalLoader, CommonDialog } from "../../../index";
import { PeopleCountingHeatmap1_1 } from "./PeopleCountingHeatmap1_1";
import { convertToUTC } from "../../../../utils/convertToUTC";
import { useSignalRContext } from "../../../../context/SignalRContext";

const PeopleCountingHeatmapWidget: React.FC<IWidgetRequestProps> = ({
  item,
  floor,
  zones,
  selectedStartDate,
  ...
  const fetchDevicesByFloorZone = async () => {
    ...
    try {
      ...
      console.error("Error fetching heatmap by floorzone data:", error);
      throw error;
    } finally {
      setLoadingCount((c) => c - 1);
    }
...
export { PeopleCountingHeatmapWidget };
