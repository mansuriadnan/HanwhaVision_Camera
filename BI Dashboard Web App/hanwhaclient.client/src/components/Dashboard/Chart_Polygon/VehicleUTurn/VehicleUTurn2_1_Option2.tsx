...
const VehicleUTurn2_1_Option2: React.FC<IVehicleUTurnProps> = ({
  customizedHeight,
  customizedWidth,
  vUTurnData,
  startDate,
  ...
  useEffect(() => {
    ...
    gradient.append("stop").attr("offset", "0%").attr("stop-color", "#394CFF");

    gradient
      .append("stop")
      .attr("offset", "100%")
      .attr("stop-color", "#04129B");
    ...
    chartGroup
      ...
      .attr("href", "/images/dashboard/Vehicle_U_Turn_detection_Node2.svg")
      .attr("href", "/images/dashboard/Vehicle_U_Turn_detection_Node2.svg")
...
export { VehicleUTurn2_1_Option2 };
