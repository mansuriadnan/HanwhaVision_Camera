...
import { AgeProps } from "../../../../interfaces/IChart";
...
const Age3_1_Option1: React.FC<AgeProps> = ({
  customizedWidth,
  customizedHeight,
  groupbyDateAgeData,
}) => {
  // console.log("groupbyDateAgeData->",groupbyDateAgeData);

  // const maleData = groupbyDateAgeData?.find((item) => item.young === "Male");
  // const femaleData = groupbyDateAgeData?.find((item) => item.gender === "Female");
  // const unknownData = groupbyDateAgeData?.find((item) => item.gender === "Unknown");
  // const unknownData = groupbyDateAgeData?.find((item) => item.gender === "Unknown");
  ...
  //   });
  // }, [customizedWidth, groupbyDateAgeData, theme]);
