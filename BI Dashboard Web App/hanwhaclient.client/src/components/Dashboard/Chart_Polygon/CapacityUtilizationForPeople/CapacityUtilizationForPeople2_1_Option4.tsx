...
const CapacityUtilizationForPeople2_1_Option4: React.FC<
    CapacityUtilizationAnanlysisProps
> = ({ capacityUtilizationpPeopleData, customizedWidth, customizedHeight }) => {
    ...
    useEffect(() => {
        ...
        const utilization = capacityUtilizationpPeopleData?.utilization || 0;
        ...
        //     .domain([0, totalCapacity * 0.5, totalCapacity]) // adjust thresholds as needed
        //     .range(["#e53935", "#ffeb3b", "#00c853"]);
    ...
    }, [capacityUtilizationpPeopleData, customizedWidth, customizedHeight, theme]);
...
export { CapacityUtilizationForPeople2_1_Option4 };
