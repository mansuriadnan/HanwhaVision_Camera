...
namespace HanwhaClient.Helper
{
    public class GlobalExceptionHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IServiceProvider serviceProvider)
        {
            ...
            var sseEndpoints = new[]
            {
                "/api/IdracDashboard/stream",
                "/api/IdracDashboard/StreamMemoryUsage",
                "/api/IdracDashboard/StreamCPUUsage",
                "/api/IdracDashboard/StreamCooling",
                "/api/IdracDashboard/StreamEmbeddedNetworkUsage",
                "/api/IdracDashboard/StreamIntegratedNetworkUsage",
            };

            var isSseEndpoint = sseEndpoints.Any(x =>
